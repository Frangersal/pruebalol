...
exit;
   ...
   if ($largo >= $alto) {		   
    ...
    mysql_query("INSERT INTO actividad(usuario, accion, fecha) VALUES('$usuario', 'Agregó un académico', '$unixtime')"); 

    mysql_query("INSERT INTO academicos(nombre, biografia, imagen) VALUES('$nombre',  '$biografia', '$newFileName1')");
