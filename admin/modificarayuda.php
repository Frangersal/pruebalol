        ...
        <div id="contenedor" class="card" style="width: calc(80% - 100px); margin-top: -195px; left: 50%; top: 50%; position: absolute; margin-left: -40%;">
            ...
            <form id="form1" name="form1" style="width: 90%;" action="" method="post" enctype="multipart/form-data">
                ...
                <div align="center" style="width: calc(100% - 40%); margin-left: 25%; float: left;">
                        ...
                        <input type="button" name="Cancelar" value="Cancelar" onclick="window.location='ayuda.php'" style="border-radius: 5px; padding: 10px 10px; font-weight: 900; font-size: 13px; cursor: pointer; border: 1px solid #848a90; margin-top: 15px; width: 150px; color: #fff; background-color: #838e98; float: left; text-transform: uppercase;">
