...
mysql_select_db($database_conamatenlinea, $conamatenlinea);
$query_Recordset11 = "SELECT * FROM inscripciones WHERE idcurso = '$idcurso'";
    ...
    <div id="wrapper" style="margin-left:20%; margin-right:10%; width:80%; padding-top: 10px; background:white;">
        ...
        <div id="cuerpocurso" style="width: 100%; float:left; margin-bottom:25px;">
            ...
            <div id="izquierda" style="padding: 5px; float:left; width: 50%; margin-left: 5%;">
                ...
                <div id="imagencurso" style="float: left; width: 50%;<?php if( $imagen == "" ) echo " border: 1px solid #eee;"; ?>">

<?php if( $imagen != "" ) { ?>

                    <img src="../images/<?php echo $imagen; ?>"  style=" width: 200px; height: 200px; margin: 10px 0px; float: left; object-fit: contain;">

<?php } else { ?>

                <div id="nohayimagen">No hay foto del curso.</div>
...
<?php } ?>
            ...
            <div id="plandeestudios" style="width: 100%;float: left;background-color: #fff;background-position: center;background-size: cover;">
                ...
                <div id="contenedormodulos" style="width: 80%;  float: left; margin-right: 10%; margin-left: 10%;">
                    ...
                    do {
                        ...
                        <div id="modulo" style="width: calc(100% - 12px); float: left; font-family: montserrat; border: 1px solid #ccc; padding: 5px; margin-bottom: 30px;">
                                ...
                                do {
                                    ...
                                    <div id="materia-maestro" style="width: calc(100% - 10px); float: left; margin: 5px;">
                                        ...
                                        <div id="contieneeditar" style="float: left; width: calc(33% - 20px); margin:10px; text-align:center;">
                                            ...
                                            <div id="eliminar" class="seleccionado" onclick="eliminarmateria(<?php echo $idmateria; ?>)" style="float: right; font-size: 13px; font-weight: bolder; cursor: pointer; letter-spacing: 1.5px; color: white; background: #9ea6ae; border-radius: 3px; margin: 1px; padding: 7px; width: calc(50% - 16px); text-align: center;">Eliminar</div>

                                            <div id="editar" class="seleccionado" onclick="editarmateria(<?php echo $idmateria; ?>);" style="text-align: center; float: left; font-size: 13px; font-weight: bolder; cursor: pointer; letter-spacing: 1.5px; color: white; background: #9ea6ae; border-radius: 3px; margin: 1px; padding: 7px; width: calc(50% - 16px);">Editar</div>
