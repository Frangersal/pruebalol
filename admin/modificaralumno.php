...
if ($_POST) {
	...
	$numero = addslashes(addslashes(trim($_POST['numero'])));
    ...
    contrasena = '$contrasena', apellidomaterno = '$apellidomaterno', apellidopaterno = '$apellidopaterno', sexo = '$sexo', curp = '$curp', estado = '$estado', municipio = '$municipio', colonia = '$colonia', calle = '$calle', codigopostal = '$codigopostal', telefono = '$telefono', curso = '$curso', idgrupo = '$grupo', dia = '$dia', mes = '$mes', ano ='$ano',numeroint = '$interior', numeroext = '$numero' WHERE id = '$idalumno'");
	
    mysql_query("UPDATE inscripciones SET idcurso = '$curso', grupo = '$grupo' WHERE idalumno = '$idalumno'"); 
...
$numero = $row_Recordset2['numeroext'];
$interior = $row_Recordset2['numeroint'];
