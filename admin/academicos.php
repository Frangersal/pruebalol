...
?>
    ...
    <div id="contenedor-academico0" class="card" align="center" style="width:calc(100% - 120px); float: left; display: none; margin-bottom: 40px;">
        
        <form id="academicoform0" name="nuevoacademicoform" action="academicos.php" enctype="multipart/form-data" method="post" style="width: 80%; float: left; margin-left: 10%;">
...
<div id="tituloseccion" style="line-height: 40px; margin-top: 10px; color:#777; border-bottom: 2px solid lightgray; margin-left: 10px; margin-right: 10px; font-size: 20px; text-align: left;">Lista de académicos (<?php echo $totalRows_Recordset1; ?>)</div>
...
?>
            ...
            <div id="academico<?php $id; ?>" style="float: left; overflow: hidden;width:calc(100% - 20px);height: 155px;background-color:#FFF;display:inline-block; border-bottom:1px solid lightgray;padding-bottom: 20px;padding-top: 20px; margin-left: 10px;">
                ...
                <div id="imagen<?php $id; ?>" style="width: 20%;height: 150px;float:left;padding-left: 10px;padding-right: 10px;background-image:url('../images/<?php echo $imagen; ?>');background-size: cover;background-position: center;background-repeat: no-repeat;">
                 ...
                 <div id="title" style="padding-right: 5%;padding-left: 5%;text-align: left;letter-spacing: 1.5px;width: 65%;line-height:20px;float:left;margin-top:20px;color:black;font-size: 18px;font-weight:bold;"><?php echo $nombre; ?></div>
