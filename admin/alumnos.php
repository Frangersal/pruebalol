...
$imagen = $_POST['imagen'];
$estadoalumno = addslashes(addslashes(trim($_POST['estadoalumno'])));
...
mysql_query("INSERT INTO alumnos(matricula, nombrealumno, correo, contrasena, imagen, estadoalumno, apellidomaterno, apellidopaterno, sexo, curp, estado, municipio, colonia, calle, codigopostal, telefono, curso, idgrupo, dia, mes, ano) VALUES('$matricula', '$nombre', '$correo', '$contrasena', '$imagen', 'activo', '$apellidomaterno', '$apellidopaterno', '$sexo', '$curp', '$estado', '$municipio', '$colonia', '$calle', '$codigopostal', '$telefono', '$curso', '$idgrupo', '$dia', '$mes', '$ano')"); 
...
?>
    ...
    <div id="seccion-form" style="width: 100%; display: none; float: left; margin-bottom: 40px; background-color: white; box-sizing: border-box; padding: 30px; border: 1px solid rgb(51, 51, 51); box-shadow: rgba(0, 0, 0, 0.08) 0px 0px 20px;">
        ...
        <div id="imagen<?php echo $id; ?>" align="center" style="width: 100px;height: 100px;float:left;background-image:url('../images/silueta.png');background-size: cover;background-position: center;background-repeat: no-repeat;margin-left: calc(50% - 50px);margin-right: calc(50% - 50px);"></div>
        ...
        <form id="form1" name="form1" action="" method="post" onsubmit="return(valida_envia())" enctype="multipart/form-data">
            ...
            <div id="nombrecompleto" style="width:100%; float:left;">
              ...
              <div id="inputs" style="width:100%; float:left; margin-top:5px;">
                ...
                <div id="etiquetas" style="width: 100%; font-size: 13px; text-align: center; float:left; margin-top:5px;">
                    ...
                    <div style="width: 25%; text-align:left; float:left;">Ciudad o Municipio</div>
                ...
                <div id="inputs" style="width:100%; float:left; margin-top:5px;">
                    ...
                    <input id="codigopostal" name="codigopostal" type="text" value=""  style="font-size: 12px;width: calc(25% - 36px); margin-left:10px; padding: 10px; border: 1px solid #e8e1e1; background-color: whitesmoke; color: gray; float:left;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">

                    <input id="municipio" name="municipio" type="text" value=""  style="font-size: 12px;width: calc(25% - 31px); margin-left: 10px; padding: 10px; border: 1px solid #e8e1e1;background-color: whitesmoke; color: gray; float:left;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
            ...
            <div id="nombrecompleto" style="width:100%; float:left; margin-top:10px;">
                ...
                <div id="etiquetas" style="width: 100%; font-size: 13px; text-align: center; float:left;">
                    ...
                    <div style="width: 33%; text-align:left; float: left;">Correo</div>
                 ...
                 <div id="inputs" style="width:100%; float:left; margin-top:5px;">
                    ...
                    <input id="correo" name="correo" type="text" value=""  style="font-size: 12px;width: calc(33% - 31px); padding: 10px; border: 1px solid #e8e1e1;background-color: whitesmoke; color: gray;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">

                    <input id="contrasena" name="contrasena" type="password" value=""  style="font-size: 12px;width: calc(33% - 31px); margin-left:10px; padding: 10px; border: 1px solid #e8e1e1; background-color: whitesmoke; color: gray;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                ...
                <div id="titulo" align="center" style="width:100%; float:left; margin-top:30px; display:none;">Inscribir</div>

            <div id="contenedorcurso" style="width: calc(50% - 5px); float: left; margin-top:5px; display:none;">
            ...
            <div id="contenedorgrupo" style="width: calc(50% - 10px); float: left; margin-left: 10px; margin-top:5px; display:none;">
...
?>
            ...
            <a href="veralumno.php?id=<?php echo $id; ?>"><div id="imagen<?php echo $id; ?>" style="width:80px; height:80px; float:left; margin-top:10px; background-image:url('../images/<?php if ($imagen != "") {  echo $imagen;} else{ echo "silueta.png";} ?>');background-size: cover; background-position: center; background-repeat: no-repeat; margin-left: 10px;"></div></a>

                <a href="veralumno.php?id=<?php echo $id; ?>"><div id="title" align="left" style="width: calc(100% - 110px); line-height:20px; float:left; margin-top:10px; color:#000; font-size: 14px; font-weight:bold; margin-left:10px;"><?php echo $nombre; ?> <?php echo $apellidopaterno; ?> <?php echo $apellidomaterno; ?></div></a>
