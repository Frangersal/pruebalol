...
?></select> <div id="lineaunion" style="width: 25px; border: 1px solid #c1c3c7; float: left; margin-top: 20px;"> </div><select id="maestro1" name="maestro1" style="height: 40px; font-size: 12px; width: calc(50% - 14px);  box-sizing: border-box; padding:10px; border: 2px solid lightgray; background-color: whitesmoke; color: gray; float: left;"><option value="">Selecciona un maestro</option><?php
...
$('#materias' + nummodulo).append('<div id="contenedormateria'+ nummaterias +'" style="width: 100%;float: left; margin:5px 0px"> <select id="materia'+ nummaterias +'" name="materia'+ nummaterias +'" style="font-size: 12px; width: calc(50% - 14px); box-sizing: border-box; height: 40px; padding:10px; border: 2px solid lightgray; background-color: whitesmoke; color: gray; float: left;">Materias<option value="">Selecciona una materia</option><?php
        ...
        <div id="contenedormodulo" style="width: 70%;float: left;margin-bottom: 10px;margin-left: 15%;margin-right: 15%;">
            ...
            <div id="modulo" name="contenedormcodulo" style="font-size: 12px;width: calc(100% - 22px);padding: 10px;float: left;border: 1px solid lightgray;">
                ...
                <div id="materias<?php echo $modulo; ?>">
                    ...
                    <div id="contenedormateria<?php echo $materiaactual; ?>" style="width: 100%;float: left;margin: 5px 0px;">

                        <select id="materia<?php echo $materiaactual; ?>" name="materia<?php echo $materiaactual; ?>" style="font-size: 12px; height: 40px; width: calc(50% - 14px); box-sizing: border-box; padding:10px; border: 2px solid lightgray; background-color: whitesmoke; color: gray; float: left;">
...
?>
                        ...
                        <select id="maestro<?php echo $materiaactual; ?>" name="maestro<?php echo $materiaactual; ?>" style="font-size: 12px;width: calc(50% - 14px); height: 40px; box-sizing: border-box; padding:10px; border: 2px solid lightgray; background-color: whitesmoke; color: gray; float: left;">
...
?>
        ...
        <div id="contenedorboton" align="center" style="float: left; width: 100%; margin-top: 50px; margin-bottom: 20px;">
            ...
            <button type="button" onclick="location.href='cursos.php'" style=" padding: 5px 15px; background-color: gray; font-size: 14px; border-color: #c5d3d9; color: white; cursor: pointer;">REGRESAR</button>
        
            <button type="button" onclick="guardarform(<?php echo $idcurso; ?>);" style=" padding: 5px 15px; background-color: #1d4267; font-size: 14px; border-color: #7FDBFF; color: #7FDBFF; cursor: pointer;">Guardar cambios</button>
