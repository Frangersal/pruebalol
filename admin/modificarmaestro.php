...
if ($_POST) {
	...
	$maestrousuario = addslashes(addslashes(trim($_POST["maestrousuario"])));
    ...
    mysql_query("UPDATE maestros SET nombre = '$nombre', sexo = '$sexo', correo = '$correo', usuario = '$maestrousuario', contrasena = '$contrasena', imagen = '$newFileName1' WHERE id = '$id'");
        ...
        mysql_query("UPDATE maestros SET nombre = '$nombre', sexo = '$sexo', correo = '$correo', usuario = '$maestrousuario', contrasena = '$contrasena', imagen = '$imagenactual' WHERE id = '$id'");
...
$maestrousuario = $row_Recordset1['usuario'];
...
if ( $("#maestrocontrasena" + formnumber).val() == '') {
    ...
    alert("Por favor escribe un contraseña");
        ...
        <form id="maestroform<?php echo $id; ?>" action="modificarmaestro.php" onSubmit="valida_envia()" name="maestroform<?php echo $id; ?>" enctype="multipart/form-data" method="post">
           ...
           <div id="genero" align="left" style="width: 70%; float: left;">
            ...
            <div id="correo" align="left" style="width: 70%; float: left;">
           		...
           		<input id="maestrocorreo" name="maestrocorreo" placeholder="Escribe un correo" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(60% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="text" value="<?php echo $correo; ?>">
           	
           </div>
                     
           <div id="usuario" align="left" style="width: 70%; float: left;">
           	
           		<div id="etiquetausuario" style="float: left; width: 40%; margin-top: 5px; text-transform: uppercase; font-size: 12px; font-family: 'Open Sans', sans-serif;">Usuario: </div>
           		
           		<input id="maestrousuario" name="maestrousuario" placeholder="Escribe un usuario" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(60% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="text" value="<?php echo $maestrousuario; ?>">
           ...
           <div id="contrasena" align="left" style="width: 70%; float: left;">
           		...
           		<input id="maestrocontrasena" name="maestrocontrasena" placeholder="Escribe una contraseña" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(60% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="password" value="<?php echo $contrasena; ?>">
           ...
           <div id="recontrasena" align="left" style="width: 70%; float: left;">
           		...
           		<input id="maestrorecontrasena" name="maestrorecontrasena" placeholder="Confirma la contraseña" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(60% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="password" value="<?php echo $contrasena; ?>">
                ...
                <div align="center" style="margin-left: 12%; float: left; margin-top: 10%; margin-bottom: 10%;">
            		...
            		<div id="contenedorboton" align="center" style="float: left; width: 100%; margin-top: 20px; margin-bottom: 20px;">
            			...
            			<button type="submit" onclick="guardarcambios()" style="border-radius: 10px; line-height: 30px; background-color: #1d4267; border-color: #7FDBFF; padding-left: 20px; padding-right: 20px; margin-top: 20px; color: #7FDBFF; cursor: pointer; margin-right: 30px;">Guardar cambios</button>
