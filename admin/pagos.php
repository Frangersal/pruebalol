...
<div id="wrapper" style="width: 100%; float: left; height: 100vh; background-color: #0b2c4d; position: relative;">
    ...
    <div id="adminmenu" style="float: left; box-shadow: 0px 0px 10px #000; width: 20%; background-color: #1d4267; position: fixed; height: 100%; overflow: scroll;">
        ...
        <div id="etiquetaadmin" style="font-family: 'Montserrat', sans-serif; float: left; width: calc(80% - 20px); margin-left: 10%; margin-bottom: 50px; text-align: center; padding: 10px; border: 1px solid #fff; color: white; font-size: 18px; border-radius: 20px;">Menú admin</div>
...
?>
    ...
    <div id="nohay" align="center" style="float: left; width: 100%; color: #fff; line-height: 300px; ">Esta es la sección de pagos del administrador.</div>

        <div id="titulo" align="center" style="color: white; width: 70%; height: 100px; position: absolute; top: 50%; margin-top: -50px; left: 50%; margin-left: -35%;">
            
            <img src="../images/logotipobackground.png" style="width: 100%;">
