    ...
    <div id="seccionmain" style="float: left; width: 80%; margin-left: 20%; position: relative; min-height: 100vh;">
        ...
        <div id="contenedor" class="card" style="width: calc(80% - 100px); margin-top: -195px; left: 50%; top: 50%; position: absolute; margin-left: -40%;">
            ...
            <form id="form1" name="form1" style="width: 90%;" action="" method="post" enctype="multipart/form-data">
                ...
                <div id="titulo" style="width: 100%; margin-bottom: 40px; text-align: center; font-size: 25px; color: #58575d; font-weight: bold; letter-spacing: 1.6;">Modificar pregunta</div> 

                <input id="pregunta" name="pregunta" type="text" value="<?php echo $pregunta; ?>" placeholder="Ingresa una pregunta" style="font-size: 12px; width: 100%; margin: 10px 0; box-sizing: border-box; margin-bottom: 10px; padding: 10px 10px; border: none; background-color: #DDE3EC; color: gray;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"/>

                <textarea id="respuesta" name="respuesta" type="text" value="" placeholder="Ingresa una respuesta" style="font-size: 12px; width: 100%; margin: 10px 0; box-sizing: border-box; height: 150px; margin-bottom: 10px; padding: 10px 10px; border: none; background-color: #DDE3EC; color: gray; resize: none;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?php echo $respuesta; ?></textarea>
                ...
                <div align="center" style="width: calc(100% - 40%); margin-left: 25%; float: left;">
                        ...
                        <input type="button" name="Cancelar" value="Cancelar" onclick="window.location='./admin/ayuda.php'" style="border-radius: 5px; padding: 10px 10px; font-weight: 900; font-size: 13px; cursor: pointer; border: 1px solid #848a90; margin-top: 15px; width: 150px; color: #fff; background-color: #838e98; float: left; text-transform: uppercase;">
