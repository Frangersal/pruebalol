			...
			<?php
				...
				?>
					...
					<div id="botonregresar" align="center" style="float: left; width: 100%; margin: 30px 0px;">
						...
						<div id="regresar" onclick="location.href='cursos.php';" style="font-size: 14px; width: 150px; border: 2px solid #617ca2; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Regresar</div>
