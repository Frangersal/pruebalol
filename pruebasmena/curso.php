...
<div id="wrapper" style="width: 100%; float: left; height: 100vh; position: relative;">
	...
	<div id="seccionprincipal" style="width: 80%; float: left; margin-left: 20%; background-image: url(../images/college.jpg?id=<?php echo $unixtime; ?>); background-position: center; background-size: cover; overflow: hidden; height: 100vh;">
            ...
            <div id="titulo" align="center" style="font-size: 40px; color: white; width: 100%; font-family: 'Montserrat', sans-serif; font-weight: bold; letter-spacing: 1.3px; margin-bottom: 20px; position: absolute; top: 50%; margin-top: -50px; left: 35%; margin-left: -25%;">BIENVENID<?php if ( $sexo == "masculino" ) { echo "O"; } else { echo "A"; } ?> AL CURSO</br><?php echo $nombrecurso; ?></div>
            
            	<a id="linkcontinuar" href="elegirmateria.php" style="text-decoration: none; position: absolute; top: 65%; left: 28%; margin-left: 28%;">
