...
location.href = "modificarmaestro.php?id="+id;
...
?>
    ...
    <div id="contenedor-maestro0" class="card" align="center" style="width:calc(100% - 120px); float: left; display: none; margin-bottom: 40px;">
        ...
        <form id="maestroform0" name="nuevomaestroform" action="maestros.php" enctype="multipart/form-data" method="post" style="width: 80%; float: left; margin-left: 10%;">
            ...
            <input id="id0" name="id0" value="0" type="hidden">
            ...
            <div id="maestrosexo0" style="float: left; font-size: 13px; color: #686464; font-family: 'Open Sans', sans-serif; width: 10%;">Sexo</div>
            	...
            	<div id="opciones" style="margin-left: 2%; float: left; font-size: 13px; color: #686464; font-family: 'Open Sans', sans-serif;">
                    ...
                    <input id="femenino" type="radio" name="sexo" style="margin-left: 40px; font-size: 12px; color: #686464; font-family: 'Open Sans', sans-serif;" value="femenino"<?php if ($sexo == 'femenino') {echo 'checked'; } ?>>Femenino
...
?>
            ...
            <div id="maestro<?php $id; ?>" style="float: left; overflow: hidden;width:calc(100% - 20px);height: 155px;background-color:#FFF;display:inline-block; border-bottom:1px solid lightgray;padding-bottom: 20px;padding-top: 20px; margin-left: 10px;">
                ...
                <div id="imagen<?php $id; ?>" style="width: 20%;height: 150px;float:left;padding-left: 10px;padding-right: 10px;background-image:url('../images/<?php echo $imagen; ?>');background-size: cover;background-position: center;background-repeat: no-repeat;">
                </div>

                 <div id="nombre" style="padding-right: 5%;padding-left: 5%;text-align: left;letter-spacing: 1.5px;width: 65%;line-height:20px;float:left;margin-top:20px;color:black;font-size: 18px;font-weight:bold;"><?php echo $nombre; ?></div>
