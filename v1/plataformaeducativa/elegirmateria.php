	...
	<div id="wrapper" style="width: 100%; float: left; height: 100vh; position: relative;">
     ...
     <div id="seccionmenu" style="width: 20%; background-color: #354052; position: fixed; top: 0; left: 0; z-index: 999; height: 100%; box-shadow: 0px 0px 10px #000;">
        ...
        <div id="contenedor" style="width: calc(100% - 21%); float:right; padding: 10px;  height: 500px; ">
			...
			<div id="tituloseccion" align="center" style="float: left; width: 100%; color: #000; font-size: 30px; font-weight: bold; letter-spacing: 5px; margin-top: 40px; margin-bottom: 20px;">ELEGIR UNA MATERIA</div>

            <div id="instrucciones" align="center" style="width:100%; float:left; top: 12%; font-size: 14px; margin-bottom: 50px; text-transform: uppercase; color: #585858;"> Da click en alguna materia correspondiente a tu módulo para comenzar a trabajar.</div>
            ...
            <div id="titulomodulo" style="float: left; width: 100%;">

                <div id="titlemod" align="center" style="color: #595c7f; font-size: 22px; margin: 5px 0px; width: 100%; padding: 5px; float: left; text-transform: uppercase; letter-spacing: 3px; font-family: 'Open Sans', sans-serif;">Materias del módulo <?php echo $modulo; ?></div>
				
				<div id="separador" style="float: left; width: 100%;">
					
					<div id="lineaprincipal" style="position: relative; width: 100px; margin-left: 47%; background-color: #ddd; height: 2px;"></div>
			...
			<div id="contenedormaterias" style="width:100%; float: left; top: calc(50% - 150px); margin-bottom: 50px;">
...
?>
			...
			<?php
				...
				<div id="botonregresar" align="center" style="float: left; width: 100%; margin-top: 20px; margin-right: 2%;">
					...
					<div id="regresar" onclick="location.href='plandeestudios.php';" style="font-size: 14px; width: 150px; border: 2px solid #8095b5; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; color: #617ca2; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Regresar</div>
