...
if ($_POST) {
    ...
    mysql_query("UPDATE maestros SET nombre = '$nombre', sexo = '$sexo', correo = '$correo', imagen = '$newFileName1', celuda = '$cedula' WHERE id = '$id'");
    ...
    header("Location: maestros.php");
        ...
        mysql_query("UPDATE maestros SET nombre = '$nombre', sexo = '$sexo', correo = '$correo', cedula = '$cedula' WHERE id= '$id'");
...
function guardarform(formnumber) {
	...
	if ( $("#maestrocedula" + formnumber).val() == '') {
		
		alert("Por favor escribe la cédula");
		$("#maestrocedula" + formnumber).focus()
		return false;
	}
	...
	form_data.append('sexo' , $("#maestrosexo" + formnumber).val());
    form_data.append('correo' , $("#maestrocorreo" + formnumber).val());
	form_data.append('cedula' , $("#maestrocedula"+ formnumber).val());
...
?>
    ...
    <div id="contenedor-maestro<?php echo $id; ?>" class="card" align="center" style="width:calc(70% - 120px); margin-left: 15%; float: left; margin-bottom: 40px;">
        
        <form id="maestroform<?php echo $id; ?>" name="maestroform<?php echo $id; ?>" enctype="multipart/form-data" method="post">
            ...
            <input id="maestronombre<?php echo $id; ?>" name="maestronombre<?php echo $id; ?>" placeholder="Escribe un nombre" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(70% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="text" value="<?php echo $nombre; ?>">
            
            <input id="maestrocorreo<?php echo $id; ?>" name="maestrocorreo<?php echo $id; ?>" placeholder="Escribe un correo" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(70% - 12px); margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="email" value="<?php echo $correo; ?>">
            
            <div id="genero" name="genero" value="1" style="font-size: 12px; float: left;" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
                
                <div id="nombregenero" style="float: left; margin-top: 10px;">Sexo</div>
                
                <div id="opciones" style=" font-family: arial; margin-top: 10px; font-size: 14px; float: left;">
                ...
                <div align="center" style="margin-left: 12%; float: left; margin-top: 10%; margin-bottom: 10%;">
            		...
            		<div id="contenedorboton" align="center" style="float: left; width: 100%; margin-top: 20px; margin-bottom: 20px;">
            			...
            			<button onclick="guardarform('<?php echo $id; ?>');" style="border-radius: 10px; line-height: 30px; background-color: #1d4267; border-color: #7FDBFF; padding-left: 20px; padding-right: 40px; margin-top: 20px; color: #7FDBFF; cursor: pointer; margin-right: 30px;">Guardar cambios</button>
