...
?>
<div id="emails" style="width:100%; float:left; padding-top:5px; padding-bottom:5px; border-bottom:#ccc solid 1px;<?php if ($leido == "") { ?>font-weight:bold;<?php } else { ?>font-weight:300;<?php } ?>">
     <a href="javascript:mensaje('<?php echo $idmensaje; ?>', 'mensajes');">
     
     <div id="nom" align="left" style="width:54%; font-size:16px; line-height:20px; float:left; margin-left:2%; overflow:hidden; color:#333;"><?php echo $remitente; ?></div>
