...
<div id="emails" style="width:90%; float:left; border: solid 2px #760204; font-weight:500; margin-left:5%; border-radius:7px; margin-top:20px; padding-bottom:10px;">
     ...
     <div id="nom" align="left" style="width:49%; font-size:14px; line-height:30px; float:left; margin-left:1%; overflow:hidden;">Reportaste a<?php if ($tipo == "cliente") { ?>l cliente <?php } else { ?> la tienda <?php } ?><strong><?php echo $nombrereportado; ?></strong></div>
     
     <div id="fech" align="right" style="width:49%; margin-right:1%; float:right; font-size:12px; line-height:30px; overflow:hidden;"><?php echo $di; ?> <?php echo $dia; ?>/<?php echo $mes1; ?>/<?php echo $ano; ?>, <?php echo $h; ?>:<?php echo $m; ?></div>
     
      <div id="tem" align="center" style="width:90%; margin-left:4%; float:left; margin-top:5px; font-size:12px; line-height:30px; overflow:hidden;"><?php if ($respuesta != '') { 
