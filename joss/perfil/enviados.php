...
?>
<div id="emails" style="width:100%; float:left; border-bottom:#ccc solid 1px; font-weight:300;">
     <a href="javascript:mensaje('<?php echo $idmensaje; ?>','enviados');">
     ...
     <div id="nom" align="left" style="width:calc(39% - 12px); height:30px; font-size:12px; line-height:30px; float:left; margin-left:5px; overflow:hidden;">Enviado a: <?php echo $destinatario; ?></div>
     
      <div id="tem" align="left" style="width:calc(30% - 14px); margin-left:1%; float:left; height:30px; font-size:12px; line-height:30px; overflow:hidden;"><?php echo stripslashes(stripslashes($tema)); ?></div>
...
<input type="hidden" id="seccion" name="seccion" value="enviados">
