...
<div id="wrapper" style="width: 100%; float: left; height: 100vh; position: relative;">
	...
	<div id="seccionprincipal" style="width: 80%; float: left; margin-left: 20%; background-color: #fff; background-position: center; background-size: cover; overflow: scroll; height: 100vh;">
		...
		<div id="contenedor" style="margin: 0px 10%; width: calc(80% - 10px); float: left; padding: 5px;">

			<div id="numsesion" align="center" style="width: 100%; float: left; font-size: 22px; margin-bottom: 20px; text-transform: uppercase; color: #545f6f; letter-spacing: 2px; font-weight: bold; padding-top: 15px;">Sesion 1</div>


			<div id="contienebloques" style="width: calc(100% - 12px); padding: 5px; float: left; border: 1px solid #ccc;">

			<div style="font-size:10px; float:left; width:100%;">Contiene:</div>

				<div id="titulobloque"  style="text-align: left; width: calc(100% - 20px); float: left; font-size: 13px; text-transform: uppercase; color: #585858; letter-spacing: 2px; margin: 10px;">Bloque  1 - Titles could have a long name</div>

				<div id="titulobloque"  style="text-align: left; width: calc(100% - 20px); float: left; font-size: 13px; text-transform: uppercase; color: #585858; letter-spacing: 2px; margin: 10px;">Bloque  2 - Titles could have a long name</div>
			
				<div id="titulobloque"  style="text-align: left; width: calc(100% - 20px); float: left; font-size: 13px; text-transform: uppercase; color: #585858; letter-spacing: 2px; margin: 10px;">Bloque  3 - Titles could have a long name</div>
            ...
            <div id="descsub"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc rutrum, libero auctor
         	...
         	<div id="botones" style="float: left; width: 100%; margin-top: 50px; margin-bottom: 50px;">
				...
				<div id="botoncontinuar" align="left" style="float: left; width: 48%; margin-top: 20px;">
					...
					<div id="continuar" onclick="location.href='teoria.php?id=<?php echo $idmateriascurso; ?>';" style="font-size: 14px; width: 150px; border: 2px solid #617ca2; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Continuar</div>
