...
<body>
	...
	<div id="wrapper" style="width: 100%; float: left; height: 100vh; position: relative;">
		...
		<div id="seccionprincipal" style="width: 80%; float: left; margin-left: 20%; background-color: #fff; background-position: center; background-size: cover; overflow: scroll; height: 100vh;">
			...
			?>
				<!---Modulo 1-->
				<div id="modulo" style="width: calc(80% - 12px); float: left; font-family: montserrat; border: 1px solid #ccc; padding: 5px; margin-bottom: 30px; margin-left: 10%; margin-right: 10%;">

					<div id="titulomodulo" style="float: left; width: 100%; border-bottom: 1px solid lightgray;">

						<div id="titlemod" style="color: #6698ac; font-weight: bold; font-size: 20px; margin: 5px 0px; width: calc(100% - 20%); margin-left:10%; margin-right:10%; text-align:center; float: left;">MÓDULO <?php echo $modulo; ?></div>

					</div>

					<div id="contenido" style="width:100%; float: left; text-align:center">

						<div id="cabeceras" style="color: #d30000; width: calc(100% - 6px); float:left; padding: 3px;">

							<div id="tophead" style="width: calc(50% - 4px); float:left; font-weight: bold; margin: 2px;  text-transform: uppercase;">Materia</div>

							<div id="tophead" style="width: calc(50% - 4px); float:left; font-weight: bold; margin: 2px; text-transform: uppercase;"> Maestro</div>

						</div>

					</div>
						
						<div id="contenedormaterias<?php echo $modulo; ?>" style="width: 100%; float: left; text-align:center;">
                    ...
                    ?>
							...
							<div id="materia-maestro" style="width: calc(100% - 10px); float: left; margin-left: 5px; margin-right: 5px;">

								<div id="materia<?php echo $materiaactual; ?>" style="width: calc(50% - 10px); float:left; font-weight: bold; margin: 5px; line-height: 25px;"><?php echo $nombremateria ?></div>
	
								<div id="maestro<?php echo $materiaactual; ?>" style="width: calc(50% - 10px); float:left; font-weight: bold; margin: 5px; line-height: 25px;"><?php echo $nombremaestro; ?></div>
			...
			<div id="botones" style="float: left; width: 100%; margin-top: 50px; margin-bottom: 20px;">
				...
				<div id="botonregresar" align="center" style="float: left; width: 100%; margin-top: 20px;">
					...
					<div id="regresar" onclick="location.href='elegirmateria.php';" style="font-size: 14px; width: 150px; border: 2px solid #bccdd4; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; color: #73848c; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Regresar</div>
