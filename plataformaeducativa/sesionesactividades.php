...
<body>
        <!---Wrapper-->
        <div id="wrapper" style="width: 100%; height: 100%; float: left; position: fixed;">
        ...
        <div id="contenedor" align="center" style="margin-right: 15%; margin-left: 27%; width: 65%; float:left; padding: 5px; position: relative;">
            ...
            <div id="instrucciones" align="center" style="width:100%; float:left; top: 12%; font-size: 14px; margin-bottom: 50px; text-transform: uppercase; color: #585858;">Las actividades estan divididas en 5 sesiones.</div>
           		...
           		<div id="cabeceras" style="width: calc(100% - 26px); float: left; padding: 10px; border: 3px double #d2d3d8bd; margin-bottom: 10px; overflow: hidden;">
           			
           			<div id="titulosesion" style="width: 30%; float: left; font-size: 16px; text-transform: uppercase; color: #000; font-weight: bold; letter-spacing: 3px; overflow: hidden;">Sesión</div>
           			
           			<div id="tituloestatus" style="width: 30%; float: left; font-size: 16px; text-transform: uppercase; color: #000; font-weight: bold; letter-spacing: 3px; overflow: hidden; ">Estatus</div>
           			
           			<div id="textocalificacion" style="width: 40%; float: left; font-size: 16px; text-transform: uppercase; color: #000; font-weight: bold; letter-spacing: 3px; overflow: hidden;">Calificación</div>
           			
           		</div>
           		
           								
           		<div id="contenedorsesion" align="center" style="width: calc(100% - 6px); float: left; border: 3px double #d2d3d8bd;">
            		
            		<div id="datossesion" style="padding: 5px; width: calc(100% - 10px); float: left; overflow: hidden;">
						
						<a id="linkcontinuar" href="datosbloque.php?id=<?php echo $idmateriascurso; ?>">
							
            				<div id="sesion" style="width: calc(30% - 10px); float: left;"> Sesion 1.</div>
            			</a> 
            		
            			<div id="estatus" style="width: calc(30% - 10px); float: left;">Completa</div>
            		
            			<div id="calificacion" style="width: 40%; float: left;">
            				<div id="porcentaje" style="float: left; width: calc(100% - 10px);"> 30% de la calificación.</div>
            			</div>
					...
					<div id="datossesion" style="padding: 5px; width: calc(100% - 10px); float: left; overflow: hidden;">
						...
						<a id="linkcontinuar" href="datosbloque.php?id=<?php echo $idmateriascurso; ?>">
            				<div id="sesion" style="width: calc(30% - 10px); float: left;"> Sesion 2.</div>
            			</a> 
					...
					<div id="datossesion" style="padding: 5px; width: calc(100% - 10px); float: left; overflow: hidden;">
						...
						<a id="linkcontinuar" href="datosbloque.php?id=<?php echo $idmateriascurso; ?>">
            				<div id="sesion" style="width: calc(30% - 10px); float: left;"> Sesion 3.</div>
            			</a> 
					...
					<div id="datossesion" style="padding: 5px; width: calc(100% - 10px); float: left; overflow: hidden;">
						...
						<a id="linkcontinuar" href="datosbloque.php?id=<?php echo $idmateriascurso; ?>">
            				<div id="sesion" style="width: calc(30% - 10px); float: left;"> Sesion 4.</div>
            			</a> 
