...
<?php if ($portada != "") {  ?>
        ...
        <div id="seccionprincipal" style="width: 80%; float: left; margin-left: 20%; background-image: url(../images/<?php echo $portada; ?>?id=<?php echo $unixtime; ?>); background-position: center; background-size: cover; overflow: hidden; height: 100vh;">
																							
<?php } else { ?>
			
		<div id="seccionprincipal" style="width: 80%; float: left; margin-left: 20%; background-image: url(../images/college.jpg); background-position: center; background-size: cover; overflow: hidden; height: 100vh;">

<?php } ?>
			
		<div id="pantallanegra" style="position: absolute; height: 100vh; background-color: rgba(0, 0, 0, 0.3); width: 80%;"></div>

		<div id="datos" align="center" style="width: 80%;">
				
				<div id="titulo" align="center" style="font-size: 40px; color: white; width: 100%; font-family: 'Montserrat', sans-serif; letter-spacing: 1.3px; margin-bottom: 20px; position: absolute; top: 50%; margin-top: -50px; left: 35%; margin-left: -25%; letter-spacing: 3px; text-transform: uppercase;"><?php echo $nombremateria; ?></div>
				
				<div id="botones" style="bottom: 10%; position: absolute;  width: 70%;  padding: 0px 5%;">

					<div id="botonregresar" align="left" style="float: left; width: 33.3333%; margin-top: 20px;">

						<div id="regresar" onclick="location.href='elegirmateria.php';" style=" font-size: 14px; width:calc(150px - 20px); border: 2px solid #fff; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase; ">Regresar</div>

					</div>

					<div id="botonteoria" align="center" style="float: left; width: 33.3333%; margin-top: 20px;">

						<div id="teoria" onclick="location.href='presentacion.php?id=<?php echo $idmateriascurso; ?>';" style=" font-size: 14px; width:calc(150px - 20px); border: 2px solid #fff; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Teoría</div>

					</div>

			
					<div id="botoncontinuar" align="right" style="float: left; width: 33.3333%; margin-top: 20px;">

						<div id="continuar" onclick="location.href='sesionesactividades.php?id=<?php echo $idmateriascurso; ?>';" style=" font-size: 14px; width:calc(150px - 20px); border: 2px solid #fff; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase; ">Continuar</div>
