...
<div id="seccionmenu" style="width: 20%; background-color: #354052; position: fixed; top: 0; left: 0; z-index: 999; height: 100%; box-shadow: 0px 0px 10px #000;">
    ...
    <div id="seccionprincipal" style=" background-color: white; float: left; width: 80%; position: relative; margin-left: 20%;">
        
        <div id="contenedor" style="width:70%; float:left; padding: 20px 15%; position: relative;">
            ...
            do {
               ...
               <a id="linkcontinuar" href="sesion.php?s=<?php echo $contador; ?>&id=<?php echo $idcurso; ?>&materia=<?php echo $idmateriacurso; ?>&nummodulo=<?php echo $nummodulo; ?>">

                    <div id="sesion" style="width: 60%; float: left; text-align:center;"> Sesion <?php echo $contador; ?>.</div>

                    </a> 
                    
                    <div id="estatus" style="width: 30%; float: left; text-align:center;"><?php if ( $terminado != "" ) { echo "Completado"; } else { echo "Sin Completar";  }  ?></div>
