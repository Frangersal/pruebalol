...
?>
    ...
    <div id="contenedor-curso1" class="card" style="width:calc(100% - 60px); float: left; margin-bottom: 40px;">
        ...
        <form id="cursoform1" name="nuevocursoform" action="" enctype="multipart/form-data" method="post">

            <input id="idcurso" name="idcurso" value="<php echo $idcurso; ?>" type="hidden">

            <div id="contienesubidaimagen" style="width: 25%; float: left;">

            <div id="contenedorimagenactual1" class="imagencurso" align="center" style="background-color: #c1c1c1; background-image: url(../images/<?php if ($imagen == "") { echo "nuevocurso.png"; } else { echo $imagen; } ?>); background-size: contain; background-position: center;"></div>
                ...
                <div id="up1" style="width:calc(100% - 22px); font-family: 'Montserrat', sans-serif; margin-left: 10px; color: white; margin-right: 10px; height:45px; float:left; position:relative; z-index:1;  border-radius:5px; overflow:hidden; border:solid 1px #7FDBFF; margin-top: 10px; margin-bottom: 10px; display: none; visibility:hidden;">
                ...
                <div id="contenedorcaracteristicas" style="width: 100%; float:left;">
                    ...
                    <div id="contenedorfechainicio" style="width: calc(50% - 10px); float: left; padding: 5px;">
                        ...
                        <input id="fechainicio1" name="fechainicio0" align="center" style="width:  calc(100% - 10px); line-height: 20px; padding-left: 5px;" type="text" value="<?php echo $fechainicio; ?>">
                    ...
                    <div id="contenedorfechafinal" style="width: calc(50% - 10px); float: left; padding: 5px;">
                        ...
                        <input id="fechafinal1" name="fechafinal0" align="center" style="width: calc(100% - 10px); line-height: 20px; padding-left: 5px;" type="text" value="<?php echo $fechafinal; ?>">
                    ...
                    <div id="contenedorcosto" style="width: calc(100% - 10px); float: left; padding: 5px;">
                        ...
                        <input id="costo1" name="costo1" style="width: calc(100% - 10px); line-height: 20px; padding-left: 5px;" type="text" value="<?php echo $costo; ?>">
            ...
            <input id="nombrecurso1" name="nombrecurso1" placeholder="Escribe el nombre del curso" style="resize: none; background-color: #0b2c4d; font-size: 12px; background-color: white; width: calc(75% - 32px); margin-left: 10px; margin-bottom: 10px; padding: 5px; float: left; border: 1px solid lightgray;" type="text" value="<?php echo $nombre; ?>">


            <textarea id="descripcioncurso1" name="descripcioncurso1" placeholder="Escribe la descripción del curso" style="resize: none; background-color: #0b2c4d; height: 283px; font-size: 12px; background-color: white; width: calc(75% - 32px); margin: 0px 10px; margin-bottom: 5px; padding: 5px; float: left; border: 1px solid lightgray;"><?php echo $descripcion; ?></textarea>
            ...
            <div id="contenedoretiquetas" style="width: 100%; float: left;">
                ...
                <div id="contenedormaterias" style="width: calc(50% - 10px);  float: left; padding: 5px;">
                    ...
                    <input id="nummaterias" name="nummaterias" type="hidden" value="<?php echo $totalRows_Recordset3; ?>"/>
...
?>
                ...
                <div id="contenedorlibros" style="width: calc(50% - 10px); float: left; padding: 5px;">
                    ...
                    <input id="numlibros" name="numlibros" type="hidden" value="<?php echo $totalRows_Recordset4; ?>"/>
...
?>
            ...
            <div id="contenedorboton" align="center" style="float: left; width: 100%; margin-top: 50px; margin-bottom: 20px;"><button type="button" onclick="guardarform('1');" style=" padding: 5px 15px; background-color: #1d4267; font-size: 14px; border-color: #7FDBFF; color: #7FDBFF; cursor: pointer;">Guardar cambios</button></div>
