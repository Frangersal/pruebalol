            ...
            <div id="contenedorgrupo" style="width: calc(50% - 10px); float: left; margin-left: 10px;">
                ...
                <select id="grupo" name="grupo" style="font-size: 12px; height: 50px; width: 100%;margin: 10px 0;box-sizing: border-box;padding: 10px 10px;border: none;background-color: whitesmoke;color: gray;">
                    ...
                    <div id="contenedorobservaciones" style="float: left; width: 100%; font-size: 13px; font-family: 'Montserrat', sans-serif; margin-bottom: 10px; margin-top: 10px;">Observaciones</div>
                        ...
                        <textarea id="observaciones" name="observaciones" rows="10" style="float: left; width: 100%; resize: none; color:black; font-size: 13px; font-family: 'Open Sans', sans-serif; border: 1px solid #ccc; background-color: whitesmoke;"></textarea> 
...
<?php } else { ?>
	...
	<div id="title" style="float: left; width: 100%; font-size: 14px; text-transform: uppercase;">Inscripción</div>
   	
    <div>El alumno está inscrito en el curso <?php echo $nombrecursoactual; ?></div>

    <button type="button" onclick="javascript:eliminar(<?php echo $id ?>);" style="border-radius: 5px; padding: 10px 10px; font-weight: 900; font-size: 13px; cursor: pointer; border: 1px solid #7FDBFF; margin-top: 15px; width:150px; color: #fff; background-color: #1d4267; float: left; margin-right: 50px;">ELIMINAR INSCRIPCION</button>
