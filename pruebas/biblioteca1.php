...
<div id="seccionprincipal" style="width: 80%; height: 100vh; float: left; position: relative; margin-left: 20%; background-color: #fff;">		
  ...
  <div id="titulo" align="center" style="width: 100%; float: left; margin-top: 30px; margin-bottom: 50px; font-family: 'Montserrat', sans-serif; font-size: 22px; text-transform: uppercase; letter-spacing: 2px; font-weight: bold;">Biblioteca</div>
	...
	<div id="botonregresar" align="center" style="float: left; width: 100%; margin-top: 20px; margin-right: 2%;">
		...
		<div id="regresar" onclick="location.href='index.php';" style="font-size: 16px; width: 150px; border: 2px solid #6b7584; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; color: #fff; background-color: #6b7584; border-radius: 6px; font-family: 'Montserrat', sans-serif;">Regresar</div>
	...
	<div id="contenedor-biblioteca" class="card" style="width:calc(100% - 100px); float: left;">
		...
		<div id="titulo" align="center" style="width: 100%; float: left; margin-top: 30px; margin-bottom: 30px; font-family: 'Montserrat', sans-serif; font-size: 22px; text-transform: uppercase; letter-spacing: 2px; font-weight: bold;">Módulo <?php echo $contador; ?></div>
...
?>
            ...
            <div id="modulo<?php echo $contador; ?>" style="width: calc(48% - 10px); float: left; font-family: montserrat; border: 1px solid #becae0; padding: 5px; margin-bottom: 30px; margin-right: 10px; margin-top: 20px;">

                <div id="numeromodulo" style="color: #56729c; font-weight: bold; font-size: 20px; margin: 5px 0px; width: calc(100% - 20%); margin-left:10%; margin-right:10%; text-align:center; float: left;"><?php echo $nombremateria; ?> CHECAR PHP*</div>
...
?>
            ...
            <div id="materia" style="width: 100%; float: left; text-align: center;">

                <div id="titulomateria" align="left" style="width: calc(82% - 10px); float: left; margin-left: 5px; margin-right: 5px; font-size: 14px; margin-top: 5px;">1. <?php echo $nombremateria; ?></div>
				
				<div id="botonver" style="float: left; background-color: #56729c; text-align: center; padding-top: 5px; padding-bottom: 5px; padding-left: 8px; padding-right: 8px; margin-top: 4px; margin-bottom: 2px; color: #fff; font-size: 11px; text-transform: uppercase; border-radius: 3px; cursor: pointer;">Ver libro</div>

<?php
            
                $query_Recordset8 = "SELECT * FROM libroscurso WHERE idmateriacurso = '$idmateria'";
...
?>
                    ...
                    <div id="libro"><?php echo $titulo; ?></div>
