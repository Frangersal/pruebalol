...
?>
				...
				<div id="botonregresar" align="right" style="float: left; width: 48%; margin-top: 20px; margin-right: 2%;">
					...
					<div id="regresar" onclick="location.href='presentacion.php?id=<?php echo $idmateriascurso; ?>';" style="font-size: 14px; width: 150px; border: 2px solid #617ca2; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Regresar</div>
				...
				<div id="botoncontinuar" align="left" style="float: left; width: 48%; margin-top: 20px;">
					...
					<div id="continuar" onclick="location.href='sesionesactividades.php';" style="font-size: 14px; width: 150px; border: 2px solid #617ca2; font-weight: bold; letter-spacing: 3px; text-align: center; padding: 8px; cursor: pointer; border-radius: 6px; font-family: 'Montserrat', sans-serif; text-transform: uppercase;">Continuar</div>
