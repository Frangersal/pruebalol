                       ...
                       <input id="id" name="id" value="<?php echo $id; ?>" type="hidden">
                               ...
                               <div id="datosbasicos" align="center" style="float: left; width: calc(100% - 400px); margin-left: 200px; font-size: 20px; text-transform: uppercase; font-family: 'Montserrat', sans-serif; margin-bottom: 40px; margin-top: 40px; color: #000; font-weight: bold; letter-spacing: 2px;">DATOS BÁSICOS</div>
                                ...
                                <div id="contienesubidaimagen" style="width: 30%; float: left;">
                                    ...
                                    <textarea id="presentacionmateria" name="presentacionmateria" placeholder="Escribe la presentación de la materia" style="resize: none; background-color: #0b2c4d;height: 198px;font-size: 12px;background-color: white; width: 67%; padding: 5px;float: left;border: 1px solid lightgray; margin-left: 10px;"><?php echo $presentacion; ?></textarea>
                                    ...
                                    <div id="grupotextarea" style="float: left; width: 100%;">
                                    
                                        <textarea id="introduccionmateria" name="introduccionmateria" placeholder="Escribe la introducción de la materia" style="resize: none; background-color: #0b2c4d; height: 200px; font-size: 12px; background-color: white; width: calc( 50% - 22px ); margin-right: 10px; margin-bottom: 5px; padding: 5px; float: left; border: 1px solid lightgray;"><?php echo $introduccion; ?></textarea>
                                        
                                        <textarea id="propositosmateria" name="propositosmateria" placeholder="Escribe los propósitos de la materia" style="resize: none; background-color: #0b2c4d; height: 200px; font-size: 12px; background-color: white; width: calc( 50% - 12px ); margin-bottom: 5px; padding: 5px; float: left; border: 1px solid lightgray;"><?php echo $propositos; ?></textarea>

                                    </div>

                                    <textarea id="competenciasmateria" name="competenciasmateria" placeholder="Escribe las competencias de la materia" style="resize: none; background-color: #0b2c4d; height: 200px; font-size: 12px; background-color: white; width: 99%; margin-bottom: 5px; padding: 5px; float: left; border: 1px solid lightgray;"><?php echo $competencias; ?></textarea>
