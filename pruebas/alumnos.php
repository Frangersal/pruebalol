...
$numeroext = addslashes(addslashes(trim($_POST['numero'])));
$numeroint = addslashes(addslashes(trim($_POST['interior'])));
...
mysql_query("INSERT INTO alumnos(matricula, nombrealumno, correo, contrasena, imagen, estadoalumno, apellidomaterno, apellidopaterno, sexo, curp, estado, municipio, colonia, calle, codigopostal, telefono, curso, idgrupo, dia, mes, ano, numeroext, numeroint) VALUES('$matricula', '$nombre', '$correo', '$contrasena', '$imagen', 'activo', '$apellidomaterno', '$apellidopaterno', '$sexo', '$curp', '$estado', '$municipio', '$colonia', '$calle', '$codigopostal', '$telefono', '$curso', '$grupo', '$dia', '$mes', '$ano', '$numeroext', '$numeroint')"); 
